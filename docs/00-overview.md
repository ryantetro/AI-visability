...
| [27-light-theme-dashboard-overhaul.md](./27-light-theme-dashboard-overhaul.md) | Light theme, scoring rebalance, dashboard action funnel | `src/app/globals.css`, `src/app/advanced/dashboard/`, `src/lib/scorer/index.ts` |
