...
export function CitationTrackingPanel({ report }: { report: DashboardReportData }) {
    ...
    return (
      <DashboardPanel className="p-8">
        <div className="flex flex-col items-center text-center py-8">
          ...
          <p className="mt-2 max-w-sm text-[13px] leading-relaxed text-gray-600">
          ...
          <div className="mt-5 rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-left max-w-sm">
            <p className="text-[11px] font-semibold uppercase tracking-wider text-gray-600 mb-2">How to improve</p>
  ...
  return (
    <div className="space-y-6">
      <DashboardPanel className="p-5">
        ...
        <div className="mt-5 grid grid-cols-3 gap-3">
          <div className="rounded-xl border border-[#25c972]/15 bg-[#25c972]/5 px-3 py-3 text-center">
            ...
            <p className="text-[10px] uppercase tracking-wider text-gray-600">Your domain</p>
          </div>
          <div className="rounded-xl border border-[#ff8a1e]/15 bg-[#ff8a1e]/5 px-3 py-3 text-center">
            ...
            <p className="text-[10px] uppercase tracking-wider text-gray-600">Competitor</p>
          </div>
          <div className="rounded-xl border border-gray-200 bg-gray-50 px-3 py-3 text-center">
            ...
            <p className="text-[10px] uppercase tracking-wider text-gray-600">Third-party</p>
          </div>
        </div>
      </DashboardPanel>
      ...
      <DashboardPanel className="p-5">
        <p className="mb-4 text-[10px] font-semibold uppercase tracking-[0.18em] text-gray-600">Cited Domains</p>
        <div className="overflow-x-auto">
          <table className="w-full text-left text-[12px]">
            <thead>
              <tr className="border-b border-gray-200 text-[10px] font-semibold uppercase tracking-[0.15em] text-gray-600">
                  ...
                  <tr key={domainName} className="border-b border-gray-100">
                    ...
                    <td className="py-3.5 pr-3">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div className="min-w-0">
                          ...
                          <span className="inline-block mt-0.5 rounded-full bg-gray-100 px-2 py-0.5 text-[10px] text-gray-600">
                    ...
                    <td className="py-3.5 pr-3 text-right w-[160px]">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <span className="text-[11px] tabular-nums text-gray-600">{citePct}%</span>
                      </div>
                    ...
                    <td className="py-3.5 text-right w-[160px]">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <span className="text-[11px] tabular-nums text-gray-600">{brandCitePct}%</span>
                      </div>
                      <div className="mt-1.5 h-1 w-full rounded-full bg-gray-100">
                        <div
        ...
        <DashboardPanel className="p-6">
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="group relative mt-1 shrink-0">
              <Info className="h-4 w-4 cursor-help text-gray-500 transition-colors group-hover:text-gray-600" />
              ...
              <div className="-mt-2 flex items-center justify-center gap-5">
                {activeEngines.map(e => (
                  <div key={e} className="flex items-center gap-2">
                    ...
                    <span className="text-[11px] font-medium capitalize text-gray-600">
                ...
                {engineCounts.map((ec, i) => {
                  ...
                  return (
                    <div key={ec.engine} className="flex items-start gap-3">
                      <span className="mt-0.5 text-[13px] font-bold tabular-nums text-gray-500">{i + 1}</span>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-baseline gap-1.5">
                          ...
                          <span className="text-[10px] text-gray-600">citations</span>
                        </div>
                        <div className="mt-1.5 flex items-center gap-2">
                          ...
                          <span className="text-[10px] tabular-nums text-gray-600">{pct}%</span>
                        </div>
                      </div>
                    </div>
                  );
